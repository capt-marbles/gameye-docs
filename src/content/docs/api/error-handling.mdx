...
description: 'Migrated from legacy Archbee docs path /error-handling.'
---

_Legacy migration generated file._

> Migrated from legacy URL: [/error-handling](https://docs.gameye.com/error-handling)
>
> Source last updated: 2023-07-06T11:56:30.746Z
